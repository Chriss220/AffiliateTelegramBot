...
#Read env variables
TOKEN = os.environ['6040442600:AAF14sfQ5ALrJAlQ2RHkQQ-prCWDJoiuQO0']
baseURL = os.environ['amazon.it'] 
affiliate_tag = os.environ['offertedaur04-21']
HEROKU_URL = os.environ['https://ewfrthkyuij.herokuapp.com/']
